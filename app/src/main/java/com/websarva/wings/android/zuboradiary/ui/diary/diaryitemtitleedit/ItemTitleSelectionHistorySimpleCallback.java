...
public class ItemTitleSelectionHistorySimpleCallback extends ItemTouchHelper.SimpleCallback {
    ...
    public ItemTitleSelectionHistorySimpleCallback(RecyclerView recyclerView) {
