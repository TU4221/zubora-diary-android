...
internal object SettingsRepositoryExceptionMapperImpl : SettingsRepositoryExceptionMapper {
    override fun toRepositoryException(e: DataStoreException): DomainException {
        return when (e) {
