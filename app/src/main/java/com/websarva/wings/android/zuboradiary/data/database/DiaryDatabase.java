...
/*@Database(entities =  {Diary.class, DiaryItemTitleSelectionHistoryItem.class}, version = 4, exportSchema = true,
        autoMigrations = {@AutoMigration(from = 3, to = 4, spec = DiaryDatabase.MyAutoMigration.class)})*/
@Database(entities =  {Diary.class, DiaryItemTitleSelectionHistoryItem.class}, version = 1, exportSchema = false/*,
...
public abstract class DiaryDatabase extends RoomDatabase {
    ...
    public abstract DiaryItemTitleSelectionHistoryDAO createSelectedItemTitlesHistoryDAO();
}
