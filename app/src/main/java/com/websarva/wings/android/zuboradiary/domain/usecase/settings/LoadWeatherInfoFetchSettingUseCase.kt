...
import com.websarva.wings.android.zuboradiary.domain.exception.settings.WeatherInfoFetchSettingLoadException
...
internal class LoadWeatherInfoFetchSettingUseCase(
     ...
     *
     * @return 天気情報取得設定の読み込み結果を [UserSettingResult] へ [Flow] でラップし、
                        ...
                        when (cause) {
                            is DataStorageException -> {
                                ...
                                UserSettingResult.Failure(
                                    WeatherInfoFetchSettingLoadException.LoadFailure(cause),
                                    defaultSettingValue
                                )
                            }
