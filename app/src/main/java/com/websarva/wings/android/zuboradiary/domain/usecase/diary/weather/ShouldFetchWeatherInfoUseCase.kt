...
internal class ShouldFetchWeatherInfoUseCase @Inject constructor() {
     ...
     * @return 天気情報を取得する必要がある場合は `true`、そうでない場合は `false` を [com.websarva.wings.android.zuboradiary.domain.usecase.UseCaseResult.Success] に格納して返す。
     *   このユースケースは常に成功するため、[com.websarva.wings.android.zuboradiary.domain.usecase.UseCaseResult.Failure] を返すことはない。
     */
    operator fun invoke(
        inputDate: LocalDate,
