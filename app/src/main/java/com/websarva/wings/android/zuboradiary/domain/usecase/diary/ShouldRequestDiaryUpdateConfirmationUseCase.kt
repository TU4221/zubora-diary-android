 ...
 */
internal class ShouldRequestDiaryUpdateConfirmationUseCase @Inject constructor(
     ...
     *   日記存在確認処理でエラーが発生した場合は [UseCaseResult.Failure] に
     *   [DiaryUpdateConfirmationCheckException] を格納して返す。
     */
