...
import com.websarva.wings.android.zuboradiary.ui.common.recyclerview.decoration.SpacingItemProvider
import com.websarva.wings.android.zuboradiary.ui.common.recyclerview.decoration.StickyHeaderAdapter
import com.websarva.wings.android.zuboradiary.ui.common.utils.formatYearMonthString
...
import com.websarva.wings.android.zuboradiary.ui.diary.common.recyclerview.DiaryListBaseAdapter.DiaryListViewHolder
 ...
 *
 * 以下の責務を持つ:
 * - [com.websarva.wings.android.zuboradiary.ui.common.recyclerview.adapter.ListBaseAdapter]を継承し、テーマカラー対応とDiffUtilの基本機能を提供する。
 * - [com.websarva.wings.android.zuboradiary.ui.common.recyclerview.decoration.SpacingItemProvider]と[com.websarva.wings.android.zuboradiary.ui.common.recyclerview.decoration.StickyHeaderAdapter]を実装し、アイテム間の間隔とスティッキーヘッダー機能を提供する。
 ...
 *
 * @param T [com.websarva.wings.android.zuboradiary.ui.diary.common.model.DiaryListItemContainerUi]を継承する、日記リストアイテムの具体的なデータコンテナの型。
...
internal abstract class DiaryListBaseAdapter<T, VH> (
    ...
    /**
     * [DiaryListItemUi]の差分を計算するための[androidx.recyclerview.widget.DiffUtil.ItemCallback]。
