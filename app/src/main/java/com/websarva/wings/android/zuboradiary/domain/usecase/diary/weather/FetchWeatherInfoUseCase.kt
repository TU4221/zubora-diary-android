package com.websarva.wings.android.zuboradiary.domain.usecase.diary.weather
...
internal class FetchWeatherInfoUseCase @Inject constructor(
     ...
     * @return 処理に成功した場合は [com.websarva.wings.android.zuboradiary.domain.usecase.UseCaseResult.Success] に [com.websarva.wings.android.zuboradiary.domain.model.diary.Weather] を格納して返す。
     *   失敗した場合は [com.websarva.wings.android.zuboradiary.domain.usecase.UseCaseResult.Failure] に [WeatherInfoFetchException] を格納して返す。
     */
