 ...
 *
 * ユーザーが項目タイトルを編集するときに、
 * 現在の項目タイトルの情報を[com.websarva.wings.android.zuboradiary.ui.diary.edit.DiaryEditFragment]から[DiaryItemTitleEditDialog]へ渡すために使用される。
 *
 * また、ユーザーが編集を完了したときに、
 * 編集した項目タイトルの情報を[DiaryItemTitleEditDialog]から[com.websarva.wings.android.zuboradiary.ui.diary.edit.DiaryEditFragment]へ渡すために使用される。
 *
 *
