package com.websarva.wings.android.zuboradiary.ui.diary.common.viewmodel
...
internal class DiaryUiStateHelper @Inject constructor(
    ...
    /**
     * 画像ファイル名から、UIで利用可能な[com.websarva.wings.android.zuboradiary.ui.common.model.FilePathUi]を構築する。
     * @param imageFileName 対象の画像ファイル名
     * @return 構築された[com.websarva.wings.android.zuboradiary.ui.common.model.FilePathUi]。ファイル名がnullまたはパス構築に失敗した場合はnull。
     */
